...
#ifndef __CASE_SURFACE_INTERFACE_H__
#define __CASE_SURFACE_INTERFACE_H__
...
typedef RK_PLAYER_FRAMEINFO_S VIDEO_FRAMEINFO_S;

#define MAX_BUFFER_NUM      3

class RKVideoPlayer : RTSurfaceInterface {
 public:
    RKVideoPlayer();
    ~RKVideoPlayer();
...
#endif
#endif  // __CASE_SURFACE_INTERFACE_H__
